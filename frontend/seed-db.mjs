...
const firebaseConfig = {
  apiKey: "AIzaSyBxSJ59kppK5uJIFtJ2iSc3m89fTehbrwQ",
  authDomain: "ecom-65857.firebaseapp.com",
  projectId: "ecom-65857",
  storageBucket: "ecom-65857.firebasestorage.app",
  messagingSenderId: "751507553632",
  appId: "1:751507553632:web:171eeb399f07434f607205",
  measurementId: "G-69TGBWGRXT"
};
...
async function seed() {
  ...
  for (const prod of products) {
    ...
    const docId = count.toString();
    console.log(`Seeding product [${docId}]: ${prod.name}`);
